...
import { type FactoryArgs } from "./args.js";
export interface FactoryName {
    readonly library: string;
    readonly factory: string;
}
/** 카탈로그에 있는 것들. 발견 레이어와 오류 문구가 같은 표를 본다. */
export declare function listModels(): readonly FactoryName[];
/** 이 팩토리가 받는 인자 규격. 매니페스트를 쓰는 쪽이 물어볼 수 있어야 한다. */
export declare function factorySpec(library: string, factory: string): FactoryArgs;
/**
 * 이름과 인자로 실제 모델을.
 *
 ...
 */
export declare function createModel(library: string, factory: string, args?: Readonly<Record<string, unknown>>): nn.Module;
