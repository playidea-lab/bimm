...
test("카탈로그가 실린 이름을 든다", () => {
  assert.deepEqual(listModels(), [
    ...
    { library: "timm", factory: "efficientnet_b1" },
    { library: "timm", factory: "efficientnet_b2" },
    { library: "timm", factory: "efficientnet_b3" },
    { library: "timm", factory: "efficientnet_b4" },
    { library: "timm", factory: "efficientnet_b5" },
    { library: "timm", factory: "efficientnet_b6" },
